"""
Demo script to test the pain detection system without Streamlit.
Useful for debugging and testing individual components.
"""
...
def test_webcam_detection():
    """Test pain detection with webcam."""
    print("Initializing pain detection system...")
    ...
    print("Webcam initialized. Press 'q' to quit, 'b' to set baseline, 's' to save frame")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Test pain detection system")
    ...
    if args.mode == "webcam":
        ...
        if args.image:
            test_image_processing(args.image)
        else:
            print("Please provide an image path with --image")
    else:
        print("Invalid mode. Use 'webcam' or 'image'")
